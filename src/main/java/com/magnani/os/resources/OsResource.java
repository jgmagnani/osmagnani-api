...
import com.magnani.os.services.OsService;
...
public class OsResource {
	...
	//endpoint para criacao novo os
	
	@PostMapping //requisicao http de post
	public ResponseEntity<OSDTO> creat(@Valid @RequestBody OSDTO obj){
		obj = new OSDTO(service.creat(obj));
